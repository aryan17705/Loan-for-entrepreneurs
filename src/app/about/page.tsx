...
export default function AboutPage() {
  return (
    <main className="nirvaan-page min-h-screen">
      ...
      <section className="border-b border-[#dce4ec] bg-white dark:border-[#263445] dark:bg-[#0F1722]">
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-20 lg:px-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-[#071a2b] dark:text-[#F1F5F9] sm:text-5xl lg:text-6xl">
              India&apos;s Official{" "}
            ...
            <p className="mt-7 max-w-3xl text-base leading-8 text-[#5a6e85] dark:text-[#AAB7C5] sm:text-lg">
      ...
      {/* Introduction */}
      <section className="border-b border-[#dce4ec] bg-[#f6f8fb] dark:border-[#263445] dark:bg-[#111923]">
        <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8 sm:py-18 lg:px-10">
          <div className="grid gap-10 lg:grid-cols-[1fr_1.5fr] lg:gap-16">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[#071a2b] dark:text-[#F1F5F9] sm:text-4xl">
                Making financial assistance easier to discover.
              </h2>
            </div>

            <div className="space-y-5 text-[15px] leading-8 text-[#5a6e85] dark:text-[#AAB7C5] sm:text-base">
              <p>
      ...
      <section className="border-b border-[#dce4ec] bg-white dark:border-[#263445] dark:bg-[#0F1722]">
        <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8 sm:py-18 lg:px-10">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-[15px] leading-8 text-[#5a6e85] dark:text-[#AAB7C5] sm:text-base">
          ...
          <div className="mt-10 grid gap-px border border-[#dce4ec] bg-[#dce4ec] sm:grid-cols-2 lg:grid-cols-3 dark:border-[#263445] dark:bg-[#263445]">
            {[
              ...
              <div
                key={item}
                className="bg-white p-6 sm:p-7 dark:bg-[#0F1722]"
              >
        ...
        <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8 sm:py-18 lg:px-10">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={item.number}
                className="border border-[#dce4ec] bg-white dark:border-[#263445] dark:bg-[#0F1722] p-6 sm:p-7"
              >
                ...
                <h3 className="mt-7 text-lg font-extrabold text-[#071a2b] dark:text-[#F1F5F9]">
                  {item.title}
                </h3>

                <p className="mt-3 text-sm leading-7 text-[#5a6e85] dark:text-[#AAB7C5]">
                  {item.text}
                </p>
              </div>
            ))}
      ...
      <section className="border-b border-[#dce4ec] bg-white dark:border-[#263445] dark:bg-[#0F1722]">
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-20 lg:px-10">
          <div className="border-l-4 border-[#1769d2] pl-6 sm:pl-8">
            ...
            <h2 className="mt-3 max-w-4xl text-3xl font-extrabold leading-tight text-[#071a2b] dark:text-[#F1F5F9] sm:text-4xl lg:text-5xl">
              A simpler path to financial opportunities.
            </h2>

            <p className="mt-6 max-w-3xl text-[15px] leading-8 text-[#5a6e85] dark:text-[#AAB7C5] sm:text-base">
        ...
        <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8 sm:py-18 lg:px-10">
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:gap-16">
            <div>
              ...
              <h2 className="mt-3 text-4xl font-extrabold tracking-tight text-[#071a2b] dark:text-[#F1F5F9] sm:text-5xl">
                NIRVAAN
              </h2>
            </div>

            <div>
              <p className="text-[15px] leading-8 text-[#5a6e85] dark:text-[#AAB7C5] sm:text-base">
      ...
      {/* Closing */}
      <section className="bg-[#071a2b] text-white dark:bg-[#071a2b]">
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-20 lg:px-10">
          <div className="max-w-4xl">
            <p className="text-sm font-bold uppercase tracking-[0.16em] text-[#f28c28]">
              NIRVAAN
      ...
      {/* Trust */}
      <section className="bg-white dark:bg-[#0F1722]">
        <div className="mx-auto max-w-7xl px-5 py-12 sm:px-8 lg:px-10">
          <div className="border border-[#dce4ec] bg-[#f6f8fb] p-6 sm:p-8 dark:border-[#263445] dark:bg-[#111923]">
            <p className="text-sm font-bold uppercase tracking-[0.16em] text-[#1769d2]">
              Government Backed
            </p>

            <h2 className="mt-3 text-2xl font-extrabold text-[#071a2b] dark:text-[#F1F5F9] sm:text-3xl">
              A platform you can trust.
            </h2>

            <p className="mt-4 max-w-4xl text-sm leading-7 text-[#5a6e85] dark:text-[#AAB7C5] sm:text-base">
              NIRVAAN is India&apos;s Official Loan Assistance Platform, backed
              by the vision of making government financial assistance easier to
              discover and access. Built with trust, transparency, and
              accessibility at its core, NIRVAAN helps individuals find and
              understand financial support opportunities available to them.
            </p>
          </div>
        </div>
      </section>
